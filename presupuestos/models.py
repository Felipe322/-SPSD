...
class Actividad(models.Model):
    ...
    monto = models.DecimalField('Monto', decimal_places=2,max_digits=7, blank=True, null=True)
    ...
    def __str__(self):
        return str(self.programa)+" "+str(self.componente)+" "+str(self.actividad)+" " +str(self.monto)+" "+str(self.descripcion)+" "+str(self.mes)+" "+str(self.partida)+" "+str(self.anio)
