Característica: Agregar un gasto
    ...
    Escenario: Datos correctos
        ...
        Y capturo los datos: Descripcion "Se compraron muchos lápices", Proveedor "La comer S.A C.V", Precio Unitario "2.50", Cantidad "300", Fecha "12/12/2020", Actividad "27 2 3"
