...
Característica: Agregar un capítulo
	...
	Y selecciono el capitulo "2000 - MATERIALES Y SUMINISTROS"
	Y remplazo el Nombre por "MATERIALES Y SUMINISTROS 2"
	Cuando presiono el botón Guardar
	Entonces puedo ver en capitulo "2000 - MATERIALES Y SUMINISTROS 2" modificado en la lista de capítulos
=======
