...
def step_impl(context):
    context.driver.find_element_by_xpath('//*[@id="content-main"]/div[3]/table/tbody/tr[2]/td[1]/a').click()
    time.sleep(0.5)
...
def step_impl(context, clave, nombre, descripcion, capitulo):
    ...
    context.driver.find_element_by_xpath('//*[@id="id_capitulo"]').send_keys(capitulo)
    time.sleep(0.5)

@when(u'presiono el botón Guardar de la partida')
def step_impl(context):
    context.driver.find_element_by_xpath('//*[@id="partida_form"]/div/div/input[1]').click()
