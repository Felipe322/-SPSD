...
def step_impl(context):
    context.driver.find_element_by_xpath('/html/body/nav/div/ul/li[3]/a').click()
    context.driver.find_element_by_xpath('//*[@id="navbarSupportedContent"]/ul/li[3]/div/a[1]').click()
    time.sleep(0.5)
