...
def step_impl(context, clave, nombre):
    time.sleep(1)
    context.driver.find_element_by_xpath(
        '/html/body/div/div[3]/div/div[1]/div/form/div/fieldset\
            /div[1]/div/input').send_keys(clave)
    time.sleep(1)
    context.driver.find_element_by_xpath(
        '/html/body/div/div[3]/div/div[1]/div/form/div/fieldset/\
            div[2]/div/input').send_keys(nombre)
...
def step_impl(context):
    time.sleep(1)
    context.driver.find_element_by_xpath(
        '/html/body/div/div[3]/div/div[1]/div/form/div/div/input[1]').click()
...
def step_impl(context):
    time.sleep(0.5)
    context.driver.find_element_by_xpath(
        '//*[@id="content-main"]/div[3]/table/tbody/tr[1]/td[1]/a').click()
...
def step_impl(context):
    context.driver.find_element_by_xpath(
        '//*[@id="capitulo_form"]/div/div/input[1]').click()
