...
class Capitulo(models.Model):
    clave = models.IntegerField('Clave', primary_key=True, validators=[
                                ...
                                RegexValidator(regex='[1-9][0]{3,3}',message='Ingrese un capítulo válido')])
...
class Partida(models.Model):
    clave = models.IntegerField('Clave', validators=[MaxValueValidator(
        9000), MinValueValidator(1000),RegexValidator(regex='[0-9]{4,4}',message='Ingrese una partida válida')], primary_key=True)
