...
class Capitulo(models.Model):
    clave = models.IntegerField('Clave',primary_key=True,validators=[MaxValueValidator(9000) ]   )
...
class Partida(models.Model):
    clave = models.IntegerField('Clave',validators=[MaxValueValidator(9000)] ,primary_key=True)
